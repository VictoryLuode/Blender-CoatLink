...
File > Export To > CoatLinkBridge in 3D-Coat - NOT the official "Bring object
...
def main():
    ...
    step("waiting for the return", "up to %d s - in 3D-Coat press File > Export To > CoatLinkBridge" % timeout)
